...
This research will focus on how to make the NDN naming scheme interoperable and scalable with multiple PID providers such that the workflows at e.g. SeaDataCloud can be optimized \cite{icn-resteam}.
\end{abstract}
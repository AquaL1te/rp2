...
%We simulated the use of \gls{tosca} with an orchestrator like DRIP by using the YAML configuration of Kuberenetes which acts as a \gls{tosca} template and the processing of this template